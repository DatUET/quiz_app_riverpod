...
import 'package:quiz_app_flutter/models/falure_model.dart';
import 'package:quiz_app_flutter/models/question_model.dart';
import 'package:quiz_app_flutter/repositories/quiz/base_quiz_repository.dart';
...
class QuizRepository extends BaseQuizRepository {
  ...
  Future<List<Question>> getQuestions(
    ...
    try {
      ...
      print(e);
      Failure(message: 'Please check your connection');
    } catch (e) {
      print(e);
    }
  }
